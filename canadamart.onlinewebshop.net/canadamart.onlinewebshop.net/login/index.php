...
<head>
  ...
  <title>Log In | Canada Mart</title>
</head>
...
<body>
  ...
  <div class="container text-center w-50 pt-5 mt-5 mb-5">
    <div id="alert-passwd-recov"></div>
    ...
    <form action="login.php" method="post" id="login-form">
      <div class="row">
        <input type="email" id="inputEmail" placeholder="Email address" name="email" class="form-control mb-2" required autofocus> </input>
      </div>
      <div class="row mb-3">
        <input type="password" id="inputPassword" placeholder="Password" name="password" class="form-control" required autofocus></input>
      </div>
      ...
      <div class="row">
        ...
        <script>
          ...
          function alertPasswordRecov() {
            var div = document.getElementById("alert-passwd-recov");
            ...
            dismiss_button.setAttribute("class", "btn-close");
            dismiss_button.setAttribute("data-bs-dismiss", "alert");
            dismiss_button.setAttribute("type", "button");
            alert.innerHTML = "A link to change your password has been sent to [email]"
        ...
        <div class="col-md-4">
          <button type="button" class=" btn btn-link mb-3 w-75" id="forgotpassword-button" onclick="alertPasswordRecov()">
            Forgot password?
          </button>
        </div>
        <div class="col-md-4">
    ...
    <div class="row pb-5 mb-5">
      <div class="col">
        ...
        <button onclick="login()" type="button" class="bg-dark btn btn-lg btn-primary w-50" id="submit-button">
          Sign In
        </button>
      </div>
    </div>
