...
<head>
  ...
  <title>Snacks | Canada Mart</title>
  ...
  <nav class="navbar navbar-expand-lg navbar-dark bg-dark">
    <div class="container-md mt-2">
      ...
      <a class="navbar-brand" href="/">
        ...
        <span class="fs-4" style="font-family: Fugaz One;">Mart</span>
      </a>
      <!-- Cart -->
    ...
    <div class="row">
      <div class="col-12">
        ...
        <div class="py-3 d-flex d-md-block justify-content-between align-items-center">
          <h1 class="text-center font-weight-bolder">Snacks</h1>
        ...
        <div class="row row-cols-2 row-cols-lg-3 gx-2 gx-sm-3 gx-lg-4 gy-4 g-xxl-5 my-3">
          <div class="col">
            <div class="card h-100 shadow-sm">
              <img src="https://dummyimage.com/300x200" alt="" class="card-img-top">
              <div class="card-body">
                <h4 class="text-black">$3.99</h4>
                <h6 class="text-dark">
                  <a href="/product/?id=61" class="stretched-link text-decoration-none text-reset">Raspberry cereal
                    bars,
                    Nutri-Grain</a>
                </h6>
                <p class="text-secondary m-0 text-truncate">
                  <small>Delicious filling made with real fruit and has a soft baked texture</small>
                </p>
              </div>
            </div>
          </div>
          <div class="col">
            <div class="card h-100 shadow-sm">
              <img src="https://dummyimage.com/300x200" alt="" class="card-img-top">
              <div class="card-body">
                <h4 class="text-black">$1.79</h4>
                <h6 class="text-dark">
                  <a href="/product/?id=62" class="stretched-link text-decoration-none text-reset">Ice cream cups</a>
                </h6>
                <p class="text-secondary m-0 text-truncate">
                  <small>Get ready for summer fun with our ice cream cups.</small>
                </p>
              </div>
            </div>
          </div>
          <div class="col">
            <div class="card h-100 shadow-sm">
              ...
              <div class="card-body">
                ...
                <h6 class="text-dark">
                  <a href="/product/?id=63" class="stretched-link text-decoration-none text-reset">Dried
                    cranberries</a>
                </h6>
                <p class="text-secondary m-0 text-truncate">
                  <small>Proudly Canadian, gluten free and made in a peanut free facility.</small>
                </p>
              </div>
            </div>
          </div>
          <div class="col">
            <div class="card h-100 shadow-sm">
              ...
              <div class="card-body">
                <h4 class="text-black">$3.99</h4>
                <h6 class="text-dark">
                  <a href="/product/?id=64" class="stretched-link text-decoration-none text-reset">Cherry Pull 'n'
                    Peel
                    Candy</a>
                </h6>
                <p class="text-secondary m-0 text-truncate">
                  <small>Naturally and artificially flavoured candy.</small>
                </p>
              </div>
            </div>
          </div>
          <div class="col">
            <div class="card h-100 shadow-sm">
              <img src="https://dummyimage.com/300x200" alt="" class="card-img-top">
              <div class="card-body">
                <h4 class="text-black">$2.22</h4>
                <h6 class="text-dark">
                  <a href="/product/?id=65" class="stretched-link text-decoration-none text-reset">Chocolate bar, Kit
                    Kat</a>
                </h6>
                <p class="text-secondary m-0 text-truncate">
                  <small>Light crispy wafer covered in milk chocolate.</small>
                </p>
              </div>
            </div>
          </div>
          <div class="col">
            <div class="card h-100 shadow-sm">
              <img src="https://dummyimage.com/300x200" alt="" class="card-img-top">
              <div class="card-body">
                <h4 class="text-black">$3.89</h4>
                <h6 class="text-dark">
                  <a href="/product/?id=66" class="stretched-link text-decoration-none text-reset">May West™ original
                    cakes</a>
                </h6>
                <p class="text-secondary m-0 text-truncate">
                  <small>A white moist cake filled with our special creme and coated in chocolate.</small>
                </p>
              </div>
            </div>
          </div>
          <div class="col">
            <div class="card h-100 shadow-sm">
              <img src="https://dummyimage.com/300x200" alt="" class="card-img-top">
              <div class="card-body">
                <h4 class="text-black">$3.29</h4>
                <h6 class="text-dark">
                  <a href="/product/?id=67" class="stretched-link text-decoration-none text-reset">Strawberry
                    flavoured
                    gel
                    snacks</a>
                </h6>
                <p class="text-secondary m-0 text-truncate">
                  <small>Strawberry flavoured gel snacks.</small>
                </p>
              </div>
            </div>
          </div>
          <div class="col">
            <div class="card h-100 shadow-sm">
              <img src="https://dummyimage.com/300x200" alt="" class="card-img-top">
              <div class="card-body">
                <h4 class="text-black">$5.29</h4>
                <h6 class="text-dark">
                  <a href="/product/?id=68" class="stretched-link text-decoration-none text-reset">Turkey breast snack
                    kit</a>
                </h6>
                <p class="text-secondary m-0 text-truncate">
                  <small>Turkey breast snack kit.</small>
                </p>
              </div>
            </div>
          </div>
          <div class="col">
            <div class="card h-100 shadow-sm">
              ...
              <div class="card-body">
                ...
                <h6 class="text-dark">
                  <a href="/product/?id=69" class="stretched-link text-decoration-none text-reset">Gourmet™ original
                    popping
                    corn</a>
                </h6>
                <p class="text-secondary m-0 text-truncate">
                  <small>A very high source of fibre and contains no artificial colors and flavours.</small>
                </p>
              </div>
            </div>
          </div>
