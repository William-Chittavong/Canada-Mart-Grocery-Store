    ...
    <div class="row">
      <div class="col-12">
        ...
        <div class="py-3 d-flex d-md-block justify-content-between align-items-center">
          <h1 class="text-center font-weight-bolder">Beverages</h1>
        ...
        <div class="row row-cols-2 row-cols-lg-3 gx-2 gx-sm-3 gx-lg-4 gy-4 g-xxl-5 my-3">
          <div class="col">
            <div class="card h-100 shadow-sm">
              <img src="img/Sprite.jpeg" alt="" class="card-img-top">
              <div class="card-body">
                <h4 class="text-black">$4.30</h4>
                <h6 class="text-dark">
                  <a href="/product/?id=51" class="stretched-link text-decoration-none text-reset">Sprite</a>
                </h6>
                <p class="text-secondary m-0 text-truncate">
                  <small>Obey your thirst</small>
                </p>
              </div>
            </div>
          </div>
          <div class="col">
            <div class="card h-100 shadow-sm">
              <img src="img/Dr pepper.jpeg" alt="" class="card-img-top">
              <div class="card-body">
                <h4 class="text-black">$3.33</h4>
                <h6 class="text-dark">
                  <a href="/product/?id=52" class="stretched-link text-decoration-none text-reset">Dr Pepper</a>
                </h6>
                <p class="text-secondary m-0 text-truncate">
                  <small>The Friendly Pepper-Upper</small>
                </p>
              </div>
            </div>
          </div>
          <div class="col">
            <div class="card h-100 shadow-sm">
              <img src="img/cherry coke.jpeg" alt="" class="card-img-top">
              <div class="card-body">
                <h4 class="text-black">$5.18</h4>
                <h6 class="text-dark">
                  <a href="/product/?id=53" class="stretched-link text-decoration-none text-reset">Cherry
                    Coca-Cola</a>
                </h6>
                <p class="text-secondary m-0 text-truncate">
                  <small>Classic cola taste with a cherry twist.</small>
                </p>
              </div>
            </div>
          </div>
          <div class="col">
            <div class="card h-100 shadow-sm">
              <img src="img/Red-bull.jpg" alt="" class="card-img-top">
              <div class="card-body">
                <h4 class="text-black">$4.99</h4>
                <h6 class="text-dark">
                  <a href="/product/?id=54" class="stretched-link text-decoration-none text-reset">Red Bull</a>
                </h6>
                <p class="text-secondary m-0 text-truncate">
                  <small>It gives you wings!</small>
                </p>
              </div>
            </div>
          </div>
          <div class="col">
            <div class="card h-100 shadow-sm">
              <img src="img/lipton citrus.jpg" alt="" class="card-img-top">
              <div class="card-body">
                <h4 class="text-black">$3.89</h4>
                <h6 class="text-dark">
                  <a href="/product/?id=55" class="stretched-link text-decoration-none text-reset">Lipton</a>
                </h6>
                <p class="text-secondary m-0 text-truncate">
                  <small>Direct from the tea gardens to the teapot</small>
                </p>
              </div>
            </div>
          </div>
          <div class="col">
            <div class="card h-100 shadow-sm">
              <img src="img/A W.jpg" alt="" class="card-img-top">
              <div class="card-body">
                <h4 class="text-black">$4.28</h4>
                <h6 class="text-dark">
                  <a href="/product/?id=56" class="stretched-link text-decoration-none text-reset">A&W</a>
                </h6>
                <p class="text-secondary m-0 text-truncate">
                  <small>Better than real Beer.</small>
                </p>
              </div>
            </div>
          </div>
