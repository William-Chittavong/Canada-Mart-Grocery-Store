...
<head>
  ...
  <title>Bread &amp; Bakery | Canada Mart</title>
    ...
    <div class="row">
      <div class="col-12">
        ...
        <div class="py-3 d-flex d-md-block justify-content-between align-items-center">
          <h1 class="text-center font-weight-bolder">Bread &amp; Bakery</h1>
        ...
        <div class="row row-cols-2 row-cols-lg-3 gx-2 gx-sm-3 gx-lg-4 gy-4 g-xxl-5 my-3">
          <div class="col">
            <div class="card h-100 shadow-sm">
              <img src="https://upload.wikimedia.org/wikipedia/commons/d/d7/Brownies.jpg" alt="" class="card-img-top">
              <div class="card-body">
                <h4 class="text-black">$4.99</h4>
                <h6 class="text-dark">
                  <a href="/product/?id=41" class="stretched-link text-decoration-none text-reset">Brownies</a>
                </h6>
                <p class="text-secondary m-0 text-truncate">
                  <small>Chocolat Favoris</small>
                </p>
              </div>
            </div>
          </div>
          <div class="col">
            <div class="card h-100 shadow-sm">
              <img src="https://upload.wikimedia.org/wikipedia/commons/6/6f/Cinnamon_Roll.jpg" alt="" class="card-img-top">
              <div class="card-body">
                <h4 class="text-black">$5.99</h4>
                <h6 class="text-dark">
                  <a href="/product/?id=42" class="stretched-link text-decoration-none text-reset">Cinnamon
                    roll</a>
                </h6>
                <p class="text-secondary m-0 text-truncate">
                  <small>Pillsbury</small>
                </p>
              </div>
            </div>
          </div>
          <div class="col">
            <div class="card h-100 shadow-sm">
              <img src="https://upload.wikimedia.org/wikipedia/commons/8/82/Box_of_Duck_Donuts_1.jpg" alt="" class="card-img-top">
              <div class="card-body">
                <h4 class="text-black">$9.99</h4>
                <h6 class="text-dark">
                  <a href="/product/?id=43" class="stretched-link text-decoration-none text-reset"> Donuts</a>
                </h6>
                <p class="text-secondary m-0 text-truncate">
                  <small>St-Michel</small>
                </p>
              </div>
            </div>
          </div>
          <div class="col">
            <div class="card h-100 shadow-sm">
              <img src="https://upload.wikimedia.org/wikipedia/commons/0/06/Chocolate_cake_with_chocolate_frosting_topped_with_chocolate.jpg" alt="" class="card-img-top">
              <div class="card-body">
                <h4 class="text-black">$12.99</h4>
                <h6 class="text-dark">
                  <a href="/product/?id=44" class="stretched-link text-decoration-none text-reset">Chocolate
                    cake</a>
                </h6>
                <p class="text-secondary m-0 text-truncate">
                  <small>Ferrero</small>
          ...
          <div class="col">
            <div class="card h-100 shadow-sm">
              <img src="https://upload.wikimedia.org/wikipedia/commons/7/7c/The_Holidays_at_-Disneyland_start_with_a_-cupcake._%28Really_tasty%2C_BTW%29_-dessertporn_-dessert_-foodporn_-pastries.jpg" alt="" class="card-img-top">
              <div class="card-body">
                <h4 class="text-black">$13.69</h4>
                <h6 class="text-dark">
                  <a href="/product/?id=45" class="stretched-link text-decoration-none text-reset">Cupcakes</a>
                </h6>
                <p class="text-secondary m-0 text-truncate">
                  <small>Two-bites</small>
                </p>
              </div>
            </div>
          </div>
          <div class="col">
            <div class="card h-100 shadow-sm">
              <img src="https://upload.wikimedia.org/wikipedia/commons/1/1f/Macaroons.jpg" alt="" class="card-img-top">
              <div class="card-body">
                <h4 class="text-black">$8.99</h4>
                <h6 class="text-dark">
                  <a href="/product/?id=46" class="stretched-link text-decoration-none text-reset">Macaroons</a>
                </h6>
                <p class="text-secondary m-0 text-truncate">
                  <small>Laura Secord</small>
                </p>
              </div>
            </div>
          </div>
          <div class="col">
            <div class="card h-100 shadow-sm">
              <img src="https://upload.wikimedia.org/wikipedia/commons/3/3e/Oreo-Two-Cookies.jpg" alt="" class="card-img-top">
              <div class="card-body">
                <h4 class="text-black">$7.99</h4>
                <h6 class="text-dark">
                  <a href="/product/?id=47" class="stretched-link text-decoration-none text-reset">Oreo</a>
                </h6>
                <p class="text-secondary m-0 text-truncate">
                  <small>Nabisco</small>
                </p>
          ...
          <div class="col">
            <div class="card h-100 shadow-sm">
              <img src="https://upload.wikimedia.org/wikipedia/commons/d/d2/Apple_raspberry_pie.jpg" alt="" class="card-img-top">
              <div class="card-body">
                <h4 class="text-black">$5.99</h4>
                <h6 class="text-dark">
                  <a href="/product/?id=48" class="stretched-link text-decoration-none text-reset">Apple Pie</a>
                </h6>
                <p class="text-secondary m-0 text-truncate">
                  <small>St-Donat</small>
                </p>
              </div>
            </div>
          </div>
          <div class="col">
            <div class="card h-100 shadow-sm">
              <img src="https://upload.wikimedia.org/wikipedia/commons/1/1f/Pecan_Pie_slice.jpg" alt="" class="card-img-top">
              <div class="card-body">
                <h4 class="text-black">$5.99</h4>
                <h6 class="text-dark">
                  <a href="/product/?id=49" class="stretched-link text-decoration-none text-reset">Pecan Pie</a>
                </h6>
                <p class="text-secondary m-0 text-truncate">
                  <small>St-Donat</small>
                </p>
