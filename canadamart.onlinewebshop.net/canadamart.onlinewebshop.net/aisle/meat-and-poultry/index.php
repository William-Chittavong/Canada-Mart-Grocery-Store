...
<head>
    ...
    <title>Meat Aisle | Canada Mart</title>
                ...
                <ul class="navbar-nav mx-auto mb-2 mb-lg-0">
                    <li class="nav-item dropdown">
                        ...
                        <ul class="dropdown-menu">
                            <li><a class="dropdown-item" href="/aisle/fruits-and-vegetables/">Fruits &amp;
                                    Vegetables</a></li>
        ...
        <div class="row">
            <div class="col-12">
                ...
                <div class="py-3 d-flex d-md-block justify-content-between align-items-center">
                    <h1 class="text-center font-weight-bolder">Meat and Poultry</h1>
                    <div class="d-none d-md-block mx-auto rounded bg-dark bar"></div>
                    <a href="#aisles" data-bs-toggle="collapse" class="d-md-none btn btn-sm btn-primary">Change
                        aisle</a>
                </div>
            </div>
            ...
            <div class="col-12 col-md-3">
                ...
                <div class="collapse" id="aisles">
                    ...
                    <div class="row g-2 text-center text-md-start">
                        ...
                        <div class="col-6 col-md-12">
                            <div class="py-2 ps-md-2 ps-lg-3 position-relative border bg-light">
                                <a href="/aisle/dairy-and-eggs/" class="stretched-link text-reset text-decoration-none">Dairy & Eggs</a>
                            </div>
                        </div>
                        <div class="col-6 col-md-12">
                            <div class="py-2 ps-md-2 ps-lg-3 position-relative border bg-light">
                ...
                <div class="row row-cols-2 row-cols-lg-3 gx-2 gx-sm-3 gx-lg-4 gy-4 g-xxl-5 my-3">
                    <div class="col">
                        <div class="card shadow-sm">
                            <img src="https://product-images.metro.ca/images/hc6/hab/9185718140958.jpg" alt="" class="card-img-top">
                            <div class="card-body">
                                <h4 class="text-black">$7.91/kg</h4>
                                <h6 class="text-dark">
                                    <a href="/product/?id=21" class="stretched-link text-decoration-none text-reset">Frozen Turkey</a>
                                </h6>
                                <p class="text-secondary m-0 text-truncate">
                                    <small>Butter Ball</small>
                                </p>
                            </div>
                        </div>
                    </div>
                    <div class="col">
                        <div class="card shadow-sm">
                            <img src="https://product-images.metro.ca/images/h2c/h9e/9188502241310.jpg" alt="" class="card-img-top">
                            <div class="card-body">
                                <h4 class="text-black">$17.60/kg</h4>
                                <h6 class="text-dark">
                                    <a href="/product/?id=22" class="stretched-link text-decoration-none text-reset">Ground Beef</a>
                                </h6>
                                <p class="text-secondary m-0 text-truncate">
                                    <small>Shwartz's</small>
                                </p>
                            </div>
                        </div>
                    </div>
                    <div class="col">
                        <div class="card shadow-sm">
                            <img src="https://product-images.metro.ca/images/h7f/had/9233874059294.jpg" alt="" class="card-img-top">
                            <div class="card-body">
                                <h4 class="text-black">$17.61/kg</h4>
                                <h6 class="text-dark">
                                    <a href="/product/?id=23" class="stretched-link text-decoration-none text-reset">Chicken Breast</a>
                                </h6>
                                <p class="text-secondary m-0 text-truncate">
                                    <small>Publix</small>
                                </p>
                    ...
                    <div class="col">
                        <div class="card shadow-sm">
                            <img src="https://product-images.metro.ca/images/hdd/h41/9233920098334.jpg" alt="" class="card-img-top">
                            <div class="card-body">
                                <h4 class="text-black">$66.12/kg</h4>
                                <h6 class="text-dark">
                                    <a href="/product/?id=24" class="stretched-link text-decoration-none text-reset">Lamb Rack</a>
                                </h6>
                                <p class="text-secondary m-0 text-truncate">
                                    <small>The Lamb Company</small>
                                </p>
                            </div>
                        </div>
                    </div>
                    <div class="col">
                        <div class="card shadow-sm">
                            <img src="https://product-images.metro.ca/images/h91/hca/8884587233310.jpg" alt="" class="card-img-top">
                            <div class="card-body">
                                <h4 class="text-black">$9.46/kg</h4>
                                <h6 class="text-dark">
                                    <a href="/product/?id=25" class="stretched-link text-decoration-none text-reset">Ham</a>
                                </h6>
                                <p class="text-secondary m-0 text-truncate">
                                    <small>Toupie</small>
                                </p>
                    ...
                    <div class="col">
                        <div class="card shadow-sm">
                            <img src="https://product-images.metro.ca/images/h3a/h02/8886412705822.jpg" alt="" class="card-img-top">
                            <div class="card-body">
                                <h4 class="text-black">$24.23</h4>
                                <h6 class="text-dark">
                                    <a href="/product/?id=26" class="stretched-link text-decoration-none text-reset">Pepper Beef Steak</a>
                                </h6>
                                <p class="text-secondary m-0 text-truncate">
                                    <small>Angus</small>
                                </p>
