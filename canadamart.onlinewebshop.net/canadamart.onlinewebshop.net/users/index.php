...
<body>
  ...
  <div class="container-fluid">
    <div class="d-flex justify-content-between align-items-center">
      <h1>List of users</h1>
      <a href="add/" class="btn btn-outline-primary">Add a user</a>
    </div>
    ...
    <div class="table-responsive">
      <table class="table table-bordered table-striped">
        ...
        <tbody>
          <?php foreach ($xml->children() as $user) {
    ...
    <td> <a class="btn btn-sm btn-primary" href="delete/?id=' . $user->id . '" ><i class="bi bi-trash-fill"></i> </a>
        <a class="btn btn-sm btn-primary" href="edit/?id=' . $user->id . '" ><i class="bi bi-pencil-fill"></i></a>
       </td>
  </tr>';
          }
          ?>
