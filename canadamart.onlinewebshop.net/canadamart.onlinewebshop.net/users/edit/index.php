...
$xml = simplexml_load_file(__DIR__ . '/../../data/users.xml') or die("Error: Cannot create object");
...
<body>
  ...
  <!-- Brand name -->
  <div class="container">
    <h2>Edit User: #<?php echo $user[0]->id; ?></h2>
    <form action="edituser.php?id=<?php echo $user[0]->id; ?>" method="post">
      <!-- Product image -->
      <div class="row mb-3">
        <label for="Email" class="col-md-3 col-form-label">Email</label>
        <div class="col-md-9">
          <input type="text" name="email" value="<?php echo $user[0]->email; ?>" class="form-control" id="Email">
        </div>
      </div>
      <div class="row mb-3">
        <label for="Password" class="col-md-3 col-form-label">Password</label>
        <div class="col-md-9">
          <input type="password" name="password" placeholder="Leave empty to use current password." class="form-control" id="Password">
        </div>
      </div>
      ...
      <div class="row mb-3">
        ...
        <div class="col-md-9">
          <input type="text" name="fname" value="<?php echo $user[0]->firstname; ?>" class="form-control" id="first name">
        </div>
      </div>
      ...
      <div class="row mb-3">
        ...
        <div class="col-md-9">
          <input type="text" name="lname" value="<?php echo $user[0]->lastname; ?>" class="form-control" id="last name">
        </div>
      </div>
      ...
      <div class="row mb-3">
        ...
        <div class="col-md-9">
          <input type="text" name="address" value="<?php echo $user[0]->address; ?>" class="form-control" id="Address">
        </div>
      </div>
      <div class="row mb-3">
        <label for="City" class="col-md-3 col-form-label">City</label>
        <div class="col-md-9">
          <input type="text" name="city" value="<?php echo $user[0]->city; ?>" class="form-control" id="City">
        </div>
      </div>
      <div class="row mb-3">
        <label for="Province" class="col-md-3 col-form-label">Province</label>
        <div class="col-md-9">
          <input type="text" name="province" value="<?php echo $user[0]->province; ?>" class="form-control" id="Province">
        </div>
      </div>
      <div class="row mb-3">
        <label for="Country" class="col-md-3 col-form-label">Country</label>
        <div class="col-md-9">
          <input type="text" name="country" value="<?php echo $user[0]->country; ?>" class="form-control" id="Country">
        </div>
      </div>
      <div class="row mb-3">
        <label for="Postal code" class="col-md-3 col-form-label">Postal code</label>
        <div class="col-md-9">
          <input type="text" name="postalcode" value="<?php echo $user[0]->postalcode; ?>" class="form-control" id="Postal code">
        </div>
      </div>
